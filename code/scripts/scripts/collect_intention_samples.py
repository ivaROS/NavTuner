...
class MultiMasterCoordinator:
    ...
    def addProcess(self):
        ...
        gazebo_master = GazeboMaster(self.task_queue, self.result_queue, self.children_shutdown, self.soft_shutdown,
    ...
    def processResults(self, queue):
        outputfile_name = "~/simulation_data/campus/results_dwa_" + str(datetime.datetime.now()) + '.csv'
